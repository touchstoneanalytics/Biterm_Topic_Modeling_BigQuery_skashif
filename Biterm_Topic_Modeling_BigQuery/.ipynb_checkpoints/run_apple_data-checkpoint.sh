...
#python3 src/tweet_cleaner.py -i apple_complaints_english.csv -o apple_complaints_english_clean.csv
...
niter=500 # changed this from 100 to 1000
save_step=1001
...
doc_pt=input/apple_complaints_english_clean.csv
