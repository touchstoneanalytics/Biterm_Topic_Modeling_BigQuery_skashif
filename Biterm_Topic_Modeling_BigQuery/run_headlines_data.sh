#!/bin/bash
# run BTM on headlines data

# Getting the headlines from Bigquery...
echo "================ Downloading Dataset ============="
python3 src/headline_downloader.py

# cleaning the input data
echo "================ Cleaning Dataset ============="
python3 src/data_cleaner.py headlines.txt headlines_clean.txt
...
niter=1000 # changed this from 100 to 1000
save_step=1001
...
doc_pt=input/headlines_clean.txt
